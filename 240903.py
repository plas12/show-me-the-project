...
def X(event):
    ...
    print(sum(orlist.curselection()), balen[sum(orlist.curselection())])
    ...
    if balen[sum(orlist.curselection())]  <  2:
        ...
        print(bac[sum(orlist.curselection())], bap[sum(orlist.curselection())], balen[sum(orlist.curselection())])
